    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        <div
          ...
          className="bg-white/80 dark:bg-gray-800/60 backdrop-blur-sm rounded-xl border border-gray-200 dark:border-gray-700 p-4 shadow-sm cursor-pointer transition-all group card-premium-hover hover-glow-blue"
        >
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-blue-100 dark:bg-blue-900/50 rounded-lg flex items-center justify-center transition-colors group-hover:bg-blue-200 dark:group-hover:bg-blue-800">
        ...
        <div
          ...
          className="bg-white/80 dark:bg-gray-800/60 backdrop-blur-sm rounded-xl border border-gray-200 dark:border-gray-700 p-4 shadow-sm cursor-pointer transition-all group card-premium-hover hover-glow-emerald"
        >
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-emerald-100 dark:bg-emerald-900/50 rounded-lg flex items-center justify-center transition-colors group-hover:bg-emerald-200 dark:group-hover:bg-emerald-800">
        ...
        <div
          ...
          className="bg-white/80 dark:bg-gray-800/60 backdrop-blur-sm rounded-xl border border-gray-200 dark:border-gray-700 p-4 shadow-sm cursor-pointer transition-all group card-premium-hover hover-glow-amber"
        >
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-amber-100 dark:bg-amber-900/50 rounded-lg flex items-center justify-center transition-colors group-hover:bg-amber-200 dark:group-hover:bg-amber-800">
        ...
        <div
          ...
          className="bg-white/80 dark:bg-gray-800/60 backdrop-blur-sm rounded-xl border border-gray-200 dark:border-gray-700 p-4 shadow-sm cursor-pointer transition-all group card-premium-hover hover-glow-purple"
        >
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-purple-100 dark:bg-purple-900/50 rounded-lg flex items-center justify-center transition-colors group-hover:bg-purple-200 dark:group-hover:bg-purple-800">
